...
export class UtenteService {
  ...
  public resetPassword(username: string){
    return this.httpClient.post<User>(magna_const.service.beUrlLogin + 'reset', {
      user : username
        });
  }

  public cambiaPassword(username: string, vecchiaPassword: string, nuovaPassword: string){
    return this.httpClient.post<User>(magna_const.service.beUrlLogin + 'cambio', {
      user : username,
      oldPass: vecchiaPassword,
      pass: nuovaPassword
        });
  }
}
